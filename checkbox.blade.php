<div class="relative" x-data="checkbox">
    <input {{ $attributes->except('class') }} class="peer sr-only" type="checkbox" x-model="checked" x-ref="checkbox">
    <span :data-checked="checked"
        ...
        data-slot="checkbox" x-on:click="toggle">
        <span class="pointer-events-none absolute inset-0 flex items-center justify-center" x-cloak x-show="checked">
            <x-lucide-check />
        </span>
    </span>
</div>
